...
public class Speaman_PlayerController2D : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKey(KeyCode.P) && !isAttackLocked)
        {
            ...
            if (!isGrounded)
            {
                Newanimator.Play("Speaman_LightJump");
                delay = .5f;
            ...
            else
            {
                ...
                delay = .4f;
                Newanimator.Play("Speaman_LightNeutral");
        ...
        else if (Input.GetKey(KeyCode.O) && !isAttackLocked)
        {
            ...
            if (!isGrounded)
            {
                Newanimator.Play("Speaman_HeavyJump");
                delay = 7.5f;
            ...
            else if (isGrounded && Input.GetKey(KeyCode.O))
            {
                ...
                //Newanimator.Play("NewPlayer_Attack" + index);
                //delay = .4f;
                Newanimator.Play("Speaman_HeavyNeutral");
        ...
        if (Input.GetKey(KeyCode.W) && isGrounded && !isDirectionalAttackLocked)
        {
            ...
            if (Input.GetKey(KeyCode.O) && !isDirectionalAttackLocked)
            {
                ...
                //Newanimator.Play("NewPlayer_Attack" + index);
                wodelay = 3.4f;
                Newanimator.Play("Speaman_HeavyHigh");
            ...
            else if (Input.GetKey(KeyCode.P) && !isDirectionalAttackLocked)
            {
                ...
                //Newanimator.Play("NewPlayer_Attack" + index);
                wpdelay = 1.4f;
                Newanimator.Play("Speaman_LightHigh");
        ...
        if (Input.GetKey(KeyCode.S) && isGrounded && !isDirectionalAttackLocked)
        {
            ...
            if (Input.GetKey(KeyCode.O) && !isDirectionalAttackLocked)
            {
                ...
                //Newanimator.Play("NewPlayer_Attack" + index);
                sodelay = 4.5f;
                Newanimator.Play("Speaman_HeavyLow");
            ...
            else if (Input.GetKey(KeyCode.P) && !isDirectionalAttackLocked)
            {
                ...
                //Newanimator.Play("NewPlayer_Attack" + index);
                spdelay = 1f;
                Newanimator.Play("Speaman_LightLow");
        ...
        if (Input.GetKey(KeyCode.L))
        {
            ...
            //audioSrc.Play();
            //shoot
            Newanimator.Play("Speaman_Throw");
            isShooting = true;

            GameObject b = Instantiate(bouncyBall);
            //b.GetComponent<Rigidbody2D>().velocity = new Vector2(3, 0);
            b.GetComponent<Speaman_Projectile>().StartShoot(isFacingLeft);
