...
public class VegetaManPlayerController2D : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else
        {
            if (Input.GetKeyDown(KeyCode.Keypad9) && !isAttacking)
            {
                ...
                if (!isGrounded)
                {
                    Newanimator.Play("VegetaMan_LightJump");
                    delay = .5f;
                ...
                else
                {
                    ...
                    //delay = .4f;
                    Newanimator.Play("VegetaMan_LightNeutral");
                ...
                else if (isGrounded == true && Input.GetKeyDown(KeyCode.Keypad9) && Input.GetKeyDown(KeyCode.DownArrow))
                {
                    ...
                    //Newanimator.Play("NewPlayer_Attack" + index);
                    //delay = .4f;
                    Newanimator.Play("VegetaMan_LightLow");
            ...
            else if (Input.GetKeyDown(KeyCode.Keypad8) && !isAttacking)
            {
                ...
                if (!isGrounded)
                {
                    Newanimator.Play("VegetaMan_HeavyJump");
                    delay = 4.5f;
                ...
                else if (isGrounded && Input.GetKeyDown(KeyCode.Keypad8))
                {
                    ...
                    //Newanimator.Play("NewPlayer_Attack" + index);
                    //delay = .4f;
                    Newanimator.Play("VegetaMan_HeavyNeutral");
            ...
            if (Input.GetKey(KeyCode.UpArrow) && isGrounded && !isDirectionalAttackLocked)
            {
                ...
                if (Input.GetKey(KeyCode.Keypad8) && !isDirectionalAttackLocked)
                {
                    ...
                    //Newanimator.Play("NewPlayer_Attack" + index);
                    wodelay = 1.4f;
                    Newanimator.Play("VegetaMan_HeavyHigh");
                ...
                else if (Input.GetKey(KeyCode.Keypad9) && !isDirectionalAttackLocked)
                {
                    ...
                    //Newanimator.Play("NewPlayer_Attack" + index);
                    wpdelay = 1.4f;
                    Newanimator.Play("VegetaMan_LightHigh");
            ...
            if (Input.GetKey(KeyCode.DownArrow) && isGrounded && !isDirectionalAttackLocked)
            {
                ...
                if (Input.GetKey(KeyCode.Keypad8) && !isDirectionalAttackLocked)
                {
                    ...
                    //Newanimator.Play("NewPlayer_Attack" + index);
                    sodelay = 1.5f;
                    Newanimator.Play("VegetaMan_HeavyLow");
            ...
            if (Input.GetKeyDown("[6]"))
            {
                ...
                //audioSrc.Play();
                //shoot
                Newanimator.Play("VegetaMan_Projectile");
                isShooting = true;

                GameObject b = Instantiate(LightningBolt);
                //b.GetComponent<Rigidbody2D>().velocity = new Vector2(3, 0);
                b.GetComponent<VegetaManFireBalls>().StartShoot(isFacingLeft);
            ...
            {
                Newanimator.Play("VegetaMan_Grab");
    ...
    private void FixedUpdate()
    {
        ...
        else
        {
            ...
            if (!isAttacking)
            {
                Newanimator.Play("VegetaMan_Jump");
            }
        ...
        if (Input.GetKey(KeyCode.RightArrow) && !isMoving)
        {
            ...
            if (isGrounded && !isAttacking)
                Newanimator.Play("VegetaMan_Run");
